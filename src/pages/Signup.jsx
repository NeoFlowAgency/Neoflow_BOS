...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store plan in sessionStorage for workspace creation step
      if (isEarlyAccess) {
        sessionStorage.setItem('neoflow_plan', 'early-access')
      }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white border-2 border-[#040741] rounded-3xl p-6 md:p-10 shadow-xl relative z-10">
        {isEarlyAccess && (
          <div className="mb-6 bg-gradient-to-r from-[#313ADF]/10 to-purple-100 border border-[#313ADF]/30 rounded-xl p-4 text-center">
            <div className="inline-flex items-center gap-2 bg-[#313ADF] text-white text-xs font-bold px-3 py-1 rounded-full mb-2">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">{isEarlyAccess ? 'Acces anticipe NeoFlow BOS' : 'Rejoignez NeoFlow BOS'}</p>
        </div>
