    ...
    <div className="p-4 md:p-8 min-h-screen">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4 mb-8">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => downloadCSV('devis', ['Référence', 'Client', 'Statut', 'Total TTC', 'Date'], filteredDevis.map(d => [
              d.quote_ref || '',
              [d.customers?.first_name, d.customers?.last_name].filter(Boolean).join(' ') || '',
              d.status || '',
              (d.total_ttc ?? d.total_amount) != null ? Number(d.total_ttc ?? d.total_amount).toFixed(2) : '',
