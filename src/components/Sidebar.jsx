...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const MobileBottomNav = () => (
    <div
      className={`md:hidden fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-[#040741] to-[#0a0b52] border-t border-white/10 transition-transform duration-200 ${isOpen ? 'translate-y-full' : 'translate-y-0'}`}
